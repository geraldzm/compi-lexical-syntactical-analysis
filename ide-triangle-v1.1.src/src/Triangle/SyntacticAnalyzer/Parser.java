...
///////////////////////////////////////////////////////////////////////////////
  ...
  // Cambio David Suarez, cambiar el parseSingleDeclaration por parseCompoundDeclaration
  // Los cambios se mantienen comentados porque no se logro terminar el parseCompoundDeclaration
  ...
  // David Suarez y Leonardo Fariña
      ...
      case Token.RECURSIVE:
        {
            ...
            accept(Token.END);            
            finish(declarationPos);
            declarationAST = new Recursive(d1AST,declarationPos);
        }
        break;
  ...
  Declaration parseProcFuncs() throws SyntaxError {
    ...
    accept(Token.AND);
    Declaration pf2AST = ProcFunc();
    finish(procFuncsPos);
    procFuncsAST = new ProcFuncs(procFuncsAST, pf2AST, procFuncsPos);
